...
# https://github.com/dangnh0611/kaggle_rsna_breast_cancer/blob/reproduce/src/utils/windowing.py
...
def _apply_windowing_torch(arr,
    ...
    if voi_func == 'LINEAR' or voi_func == 'LINEAR_EXACT':
        ...
        # .clamp(input, min=None, max=None,...) => clamps all elements in input into the range [ min, max ].
