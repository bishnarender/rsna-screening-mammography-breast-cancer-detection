...
class YOLOV5ToCOCO():
    ...
    def _init_json(self):
        '''
            Initializes the JSON structure for the COCO annotations.
        '''
    ...
    def convert(self, img_list, save_img_dir, mode):
        '''
        Converts the annotations for a list of images and returns the JSON data for COCO annotations.
        '''
        images, annotations = [], []
    ...
    def get_annotation(self, label_path: Path, img_id, height, width):
        '''
        Retrieves annotations for a given label file and returns a list of annotation dictionaries.
        '''
